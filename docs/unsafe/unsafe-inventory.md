...
|---|---|---|---|---|---|---|---|---|---|
| _(none yet — bind9-rs-platform has no unsafe blocks at this time; `#![allow(unsafe_code)]` is the crate's declaration of intent, not a license to add unsafe casually)_ | | | | | | | | | |
