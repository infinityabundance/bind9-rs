...
use bind9_core::edns::Opt;
use bind9_core::message::{header, question::Question, Message};
...
fn query_once(parsed: &DigOptions, lookup: &Lookup) -> Result<(), String> {
    ...
    let full_rcode = match &resp.opt {
        ...
        None => bind9_core::rcode::Rcode::from_u16(resp.header_rcode as u16),
    };
...
fn rand_id() -> u16 {
    ...
    match bind9_platform::random::fill_u64() {
